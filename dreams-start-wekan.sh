...
#while true; do
      ...
      export MAIL_URL='smtps://team%40cannabisworldchain.com:Lm9B7J%26mPB2d9EQxUZ%24O@smtp.gmail.com:465'
      export MAIL_FROM='Dreams ~ CANNABIS WORLD CHAIN <info@cannabisworldchain.com>'
      #---------------------------------------------
